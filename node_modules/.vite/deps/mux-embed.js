...
var X = {
	...
	var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 3, t, i, a, n, o, s = r ? [console, r] : [console], u = (t = console.trace).bind.apply(t, W(s)), p = (i = console.info).bind.apply(i, W(s)), y = (a = console.debug).bind.apply(a, W(s)), x = (n = console.warn).bind.apply(n, W(s)), D = (o = console.error).bind.apply(o, W(s)), f = e;
	return {
		trace: function() {
...
var Ne = G(Q());
function fe() {
	return (Ne.default.doNotTrack || Ne.default.navigator && Ne.default.navigator.doNotTrack) === "1";
}
function b(r) {
...
var Ct = function(r, e) {
	...
	var _ = {
		...
		if (T === "audio" || T === "video") {
			...
			_[T] = me(Z({}, E), { codec: t.getCurrentTrackFor(T).codec });
			var C = v();
...
var Fe = G(Q()), Ft = function() {
	...
	function r(e) {
		...
		k(this, r), l(this, "_playbackHeartbeatInterval", void 0), l(this, "_playheadShouldBeProgressing", void 0), l(this, "pm", void 0), this.pm = e, this._playbackHeartbeatInterval = null, this._playheadShouldBeProgressing = !1, e.on("playing", function() {
			...
			t._playbackHeartbeatInterval !== null && (Fe.default.clearInterval(t._playbackHeartbeatInterval), e.emit("playbackheartbeatend", { viewer_time: a.viewer_time }), t._playbackHeartbeatInterval = null);
		});
	}
	return N(r, [{
...
var Jt = 300 * 1e3, Qt = function r(e) {
	"use strict";
...
var zt = function() {
	...
	function r(e) {
		...
		k(this, r), l(this, "_lastCheckedTime", void 0), l(this, "_lastPlayheadTime", void 0), l(this, "_lastPlayheadTimeUpdatedTime", void 0), l(this, "_rebuffering", void 0), l(this, "pm", void 0), this.pm = e, !(e.disableRebufferTracking || e.disablePlayheadRebufferTracking) && (this._lastCheckedTime = null, this._lastPlayheadTime = null, this._lastPlayheadTimeUpdatedTime = null, e.on("playbackheartbeat", this._checkIfRebuffering.bind(this)), e.on("playbackheartbeatend", this._cleanupRebufferTracker.bind(this)), e.on("seeking", function() {
			t._cleanupRebufferTracker(null, { viewer_time: O.now() });
		}));
	}
	return N(r, [
		{
...
var $t = function(e, t) {
	...
	function r(e) {
		...
		e.on("adbreakstart", function() {
			...
			n = Object.assign({ ad_request_id: "generatedAdRequestId" + t._currentAdRequestNumber++ }, n), $t(t._adRequests, n), P(e.data, "view_ad_request_count"), t.inPrerollPosition() && (e.data.view_preroll_requested = !0, t._adHasPlayed || P(e.data, "view_preroll_request_count"));
		}), e.on("adresponse", function(a, n) {
			n = Object.assign({ ad_request_id: "generatedAdRequestId" + t._currentAdResponseNumber++ }, n), $t(t._adResponses, n);
...
var tr = "muxData", Oa = function(r) {
	...
	var e = rr(), t = O.now();
	return e.session_start && (e.sst = e.session_start, delete e.session_start), e.session_id && (e.sid = e.session_id, delete e.session_id), e.session_expires && (e.sex = e.session_expires, delete e.session_expires), (!e.sex || e.sex < t) && (e.sid = re(), e.sst = t), e.sex = t + 1500 * 1e3, ar(e), {
		session_id: e.sid,
		session_start: e.sst,
...
ee.prototype._clearBeaconQueue = function() {
	...
	r > 0 && Object.assign(e[e.length - 1], he({ mux_view_message: "event queue truncated" }));
...
ee.prototype._createPayload = function(r) {
	var e = this, t = { transmission_timestamp: Math.round(O.now()) };
	...
	return N(r, [
		{
			...
			value: function(t, i) {
				if (!(!t || !(i != null && i.view_id))) {
					...
					var o, s = ((o = n.mux_sample_number) !== null && o !== void 0 ? o : 0) >= this.sampleRate, p = he(this._deduplicateBeaconData(t, n));
...
var z = Object.freeze({
	...
	switch (r) {
		case "cellular":
		case "wimax": return z.CELLULAR;
		case "wifi": return z.WIFI;
		case "ethernet": return z.WIRED;
		case "none": return z.NO_CONNECTION;
		case "bluetooth":
		case "other": return z.OTHER;
	...
	return N(r, [
		...
		},
		{
			...
			value: function() {
				...
				t === this.lastType && i === this.lastLowDataMode || (this.lastType = t, this.lastLowDataMode = i, this.pm.emit("networkchange", Z({ viewer_connection_type: t }, i !== void 0 && { viewer_connection_low_data_mode: i })));
			}
		}
	], [{
		key: "connection",
	...
	return N(t, [
		{
			...
			value: function(a, n) {
				...
				u != null && u.length && (o = Se($(t.prototype), "emit", this)).call.apply(o, [this].concat(W(u)));
			}
		},
		{
			key: "destroy",
			...
			value: function(a) {
				if (this.data.view_id) {
					...
					if (n.video_source_is_live === void 0 && (n.player_source_duration === Infinity || n.video_source_duration === Infinity ? n.video_source_is_live = !0 : (n.player_source_duration > 0 || n.video_source_duration > 0) && (n.video_source_is_live = !1)), n.video_source_is_live || [
						...
						var s = H(ie(n.video_source_url), 2), u = s[0];
...
function ut(r, e, t) {
	var i = H(de(e), 3), a = i[0], n = i[1], o = i[2], s = r.log, u = r.utils.getComputedStyle, p = r.utils.secondsToMs, y = { automaticErrorTracking: !0 };
	if (a) {
	...
	a.mux.destroy = function() {
		...
		var _ = H(de(f), 3), v = _[0], w = _[1], h = _[2];
		if (v) {
		...
		var f = Pe(), _ = document.fullscreenElement;
...
Ve.prototype.processLine = function(r) {
	var t = Ni(r, r.indexOf(":")), i = t[0], a = t.length === 2 ? ft(t[1]) : void 0;
...
//# sourceMappingURL=mux-embed.js.map